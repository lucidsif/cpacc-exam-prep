/**
 * AI provenance for the Bear-notes-derived practice bank.
 *
 * Generated by Claude from the author's personal Bear study notes tagged
 * `#cpacc/practice` and `#a11y/*`. The notes are themselves the author's
 * distillation of various CPACC reference material, so this bank is one
 * step removed from primary sources.
 */
export const BEAR_BANK_PROVENANCE = {
