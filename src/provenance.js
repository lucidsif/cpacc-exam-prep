    ...
    <dialog id="ai-info-dialog" class="ai-dialog" aria-labelledby="ai-info-title">
      ...
      <article>
        ...
        <dl class="provenance-card">
          ...
          <dd>Authored from a citable primary source; author-stated review against the citation.</dd>
          <dt><span class="pv-conf pv-conf-med"><span aria-hidden="true">◐</span> Medium</span></dt>
          <dd>Derived from author's notes or secondary sources; author-stated spot-check, not exhaustive review.</dd>
        ...
        <p>The full <b>AI_TRANSPARENCY.md</b> document in the project repository covers the three content buckets, per-item provenance shape, confidence pill semantics, how to file a correction, and what the "reviewed" / "spot-checked" language above can and can't be taken to mean from outside.</p>
