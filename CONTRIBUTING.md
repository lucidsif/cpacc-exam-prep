...
│   └── legal.js            # 60 laws/standards × 7 jurisdictions
└── tests/
...
This app conforms to **WCAG 2.2 AA**. Every PR that touches UI must preserve:
...
- **Wrong answer** — a question's marked answer or rationale is incorrect
- **New question** — propose new bank items
- **Accessibility** — keyboard, screen reader, contrast, or other a11y bugs (these get triaged first)
